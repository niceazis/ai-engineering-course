<p align="center">
    <img alt="AI 엔지니어링 코스 - AI 엔지니어링을 단계별로 배우기" src="https://github.com/amitshekhariitbhu/ai-engineering-course/blob/main/assets/banner.png">
</p>
...
> [모듈별 한국어 상세 요약](docs/ko/README.md) · [YouTube 영상 한국어 요약](docs/ko/videos.md)
...
flowchart TD
    ...
    G --> H[프롬프트·컨텍스트 엔지니어링]
    H --> I[RAG와 벡터 검색]
    I --> J[AI 에이전트와 에이전틱 시스템]
    J --> K[에이전틱 엔지니어링과 프레임워크]
    K --> L[LLM 추론 엔지니어링]
    L --> M[평가와 관측성]
    M --> N[AI 안전과 보안]
    N --> O[멀티모달 AI와 생성 모델]
...
> [모듈 0 한국어 학습 요약](docs/ko/module-00.md)
...
> [모듈 1 한국어 학습 요약](docs/ko/module-01.md)
...
> [모듈 2 한국어 학습 요약](docs/ko/module-02.md)
...
> [모듈 3 한국어 학습 요약](docs/ko/module-03.md)
...
> [모듈 5 한국어 학습 요약](docs/ko/module-05.md)
...
> [모듈 6 한국어 학습 요약](docs/ko/module-06.md)
...
> [모듈 7 한국어 학습 요약](docs/ko/module-07.md)
...
> [모듈 8 한국어 학습 요약](docs/ko/module-08.md)
...
> [모듈 9 한국어 학습 요약](docs/ko/module-09.md)
...
> [모듈 10 한국어 학습 요약](docs/ko/module-10.md)
...
> [모듈 11 한국어 학습 요약](docs/ko/module-11.md)
...
> [모듈 12 한국어 학습 요약](docs/ko/module-12.md)
...
> [모듈 13 한국어 학습 요약](docs/ko/module-13.md)
...
> [모듈 14 한국어 학습 요약](docs/ko/module-14.md)
...
> [모듈 15 한국어 학습 요약](docs/ko/module-15.md)
...
> [모듈 16 한국어 학습 요약](docs/ko/module-16.md)
...
> [모듈 17 한국어 학습 요약](docs/ko/module-17.md)
...
> [모듈 18 한국어 학습 요약](docs/ko/module-18.md)
