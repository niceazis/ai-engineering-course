...
**순환 신경망(RNN)이란?**가 무엇인지 정의하고, 왜 필요한지, 입력과 출력이 무엇인지, 전체 학습·추론 흐름에서 어느 위치에 있는지를 연결해서 이해합니다. 가능하면 작은 수치 예제나 코드 흐름으로 직접 확인하고, 비슷한 대안과의 차이 및 trade-off까지 설명할 수 있어야 합니다.
...
1. 순환 신경망(RNN)이란?을 한 문장으로 설명할 수 있는가?
2. 왜 필요한지 설명할 수 있는가?
...
- https://outcomeschool.com/blog/recurrent-neural-network
